...
export default function PhilosophySection() {
  ...
  return (
    <section id="philosophy" ref={sectionRef} className="bg-black py-28 md:py-40 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="italic text-white/40">Innovation then x</span> Vision
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <motion.div
            ...
            className="rounded-3xl overflow-hidden aspect-[4/3] w-full relative group shadow-[0_0_50px_rgba(255,255,255,0.02)]"
          >
            <video
